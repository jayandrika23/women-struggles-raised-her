    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="80">
            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
                        <!-- MAIN IMAGE -->
                        <img src="bank3.jpg" alt="desk" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
        ...
        <footer class="footer">
            <div class="container text-center">
                <span class="alo">Akpha Bank Service</span>
