...
<div id="navbar" class="navbar-collapse collapse">
    ...
    <h1 style="color:black;text-align: center;font-family: cursive;" >Account Details</h1><br><br>
...
<br><br>
	...
	<table class="flat-table flat-table-1" align=center style="font-family: serif;color: white;">
		<tr>
		<td style="font-size:25px;"><b>Transfer To:<b></td>
		<td><select name="user">
			...
			<tr><td style="font-size:25px;"><b>Amount:<b></td><td><input type="text" name="Amount"></td></tr>
